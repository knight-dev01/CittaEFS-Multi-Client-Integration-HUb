  ...
  return (
    <div className="space-y-6 font-mono text-xs">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-4 sm:p-5 border-2 border-slate-900 space-y-4">
          ...
          <div>
            <label className="block text-xs font-black text-slate-900 uppercase mb-1">
              Parsed Spreadsheet Data Buffer (Multi-item grouping by <code className="text-amber-600">clientInvoiceNumber</code>):
            </label>
            <textarea
              rows={6}
              value={csvText}
          ...
          {csvResultMsg && (
            <div className={`p-3 text-xs font-black uppercase border-2 border-slate-900 ${
          ...
          <div className="flex justify-end space-x-2">
            <button
              ...
              className="px-4 py-2.5 bg-emerald-400 hover:bg-emerald-300 text-slate-950 border-2 border-slate-900 font-black text-xs uppercase cursor-pointer inline-flex items-center space-x-1.5 transition min-h-[44px]"
            >
        ...
        <div className="bg-slate-900 text-white p-4 sm:p-5 border-2 border-slate-900 space-y-4 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between pb-3 border-b-2 border-slate-800">
              ...
              <span className="text-[10px] bg-amber-400 text-slate-950 px-2 py-0.5 font-black uppercase border border-slate-900">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 my-4">
              ...
              <button
                ...
                className="p-3 bg-slate-950 border-2 border-slate-800 text-left hover:border-amber-400 transition cursor-pointer group min-h-[44px]"
              >
                <div className="flex items-center justify-between">
                  <span className="text-xs font-black text-white uppercase group-hover:text-amber-400">QuickBooks Online</span>
                  <Zap className="w-4 h-4 text-amber-400" />
                </div>
                <p className="text-[11px] text-slate-400 mt-1">Simulate OAuth 2.0 REST Webhook Event</p>
                <span className="mt-2 inline-flex items-center text-[10px] font-black uppercase text-amber-400">
              ...
              <button
                ...
                className="p-3 bg-slate-950 border-2 border-slate-800 text-left hover:border-emerald-400 transition cursor-pointer group min-h-[44px]"
              >
                <div className="flex items-center justify-between">
                  <span className="text-xs font-black text-white uppercase group-hover:text-emerald-400">CittaEFS Gateway (CSL)</span>
                  <ShieldCheck className="w-4 h-4 text-emerald-400" />
                </div>
                <p className="text-[11px] text-slate-400 mt-1">Simulate Gateway Webhook & Audit Sync</p>
                <span className="mt-2 inline-flex items-center text-[10px] font-black uppercase text-emerald-400">
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between text-[10px] text-slate-400 font-mono uppercase font-black">
                <span className="flex items-center gap-1"><Terminal className="w-3 h-3 text-amber-400" /> Real-time Connector Output:</span>
                <span>CDC Stream Active</span>
              </div>
          ...
          <div className="text-[11px] text-slate-400 text-center pt-2 border-t-2 border-slate-800 uppercase font-black">
            Hub ensures <strong className="text-amber-400">symmetrical bi-directional synchronization</strong> across all client platforms.
          </div>
        </div>
